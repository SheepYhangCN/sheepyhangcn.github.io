...
然后还不止分句问题
它还吞了不少翻译
{% image /resources/images/uty/crowdin/imported.png %}
...
似乎发现了什么弱智情况
{% image /resources/images/uty/crowdin/frog_pebble.png %}
对 译文乱了
{% image /resources/images/uty/crowdin/pebble_flint.png %}
《小 石 弹》
{% image /resources/images/uty/crowdin/candy_spare.png %}
《饶 恕 糖》
{% image /resources/images/uty/crowdin/chisp_matches.png %}
《柴 片》
