...
{% image https://cdn.jsdmirror.com/gh/SheepYhangCN/sheepyhangcn.github.io/source/assets/images/dttvl/dttvl_try2/options.png  ratio:1282/992 %}

之前参与过 UTY 项目的晓晓也帮忙尝试了重新编排一次英文使得中英尺寸相同的方案
然后结果是
不仅中文没好 英文也一起变形了
{% image https://cdn.jsdmirror.com/gh/SheepYhangCN/sheepyhangcn.github.io/source/assets/images/dttvl/dttvl_try2/new_font.png  ratio:969/96 %}
(注意那个百分号)
